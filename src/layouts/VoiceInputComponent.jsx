      ...
      <div className="flex flex-row items-center gap-3">
        ...
        <div className="flex w-full relative">
          <textarea
            ...
            className="w-full border border-gray-300 rounded-2xl px-4 py-3 pr-24 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white disabled:bg-gray-50"
            rows="1"
        ...
        <button
          ...
          className="bg-indigo-500 text-white rounded-2xl cursor-pointer hover:bg-indigo-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center justify-center min-w-[60px] h-[56px]"
        >
...
//   setInputMessage,
//   isLoading,
//   language = 'en-US'  // Set based on the language being learned
// }) => {
//   const [isListening, setIsListening] = useState(false);
//   const [isProcessing, setIsProcessing] = useState(false);
//   const [error, setError] = useState('');
...
//         if (transcript) {
//           setInputMessage(prev => {
//             // If there's existing text, add space and new transcript
//             if (prev && !prev.endsWith(' ') && !prev.endsWith('\n')) {
//               return prev + ' ' + transcript;
//             }
//             return prev + transcript;
